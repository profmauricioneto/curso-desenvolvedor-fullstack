        ...
        <>
            <div>
                ...
                <form onSubmit={submitCadastro}
                    ...
                    <input type="text" placeholder="enter with username" value={username} name="username" onChange={changeInput}
                ...
                <p>
                    ...
                    Vá para <button onClick={() => navigate('/cadastro')}>login!</button>
                </p>
